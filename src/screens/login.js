...
export default class Login extends Component {
  ...
  dispatchConnected(isConnected){
    _isConnected = isConnected != "NONE" ? true : false;
    this.setState({ _netStatus: _isConnected }, () => {
      console.log("Net State" + this.state._netStatus);
    });
  }
  componentWillMount() {
  ...
  render() {
    ...
    return (
      ...
      dot={
        <View style={{backgroundColor:'rgba(255,255,255,.4)', width: 20, borderRadius:3,height: 8,marginLeft: 3, marginRight: 3, marginTop: 3, marginBottom: 3,}} />
      }
      activeDot={                   
        <View style={{backgroundColor: '#FFF', width: 20, height: 8,borderRadius:3 , marginLeft: 3, marginRight: 3, marginTop: 3, marginBottom: 3,}} />
      }
      index={id} loop={false} showsButtons={false}>
        <Image                                          
          source={{
